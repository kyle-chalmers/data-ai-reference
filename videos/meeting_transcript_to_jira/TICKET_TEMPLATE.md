...
[README.md](README.md) explains the intake rule and the four outcomes, and what a data ticket needs
that a task does not. This file is the operational half: what you actually run a candidate through,
and what the surviving ones get written into.
